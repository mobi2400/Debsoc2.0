...
const Navbar = () => {
  ...
  return (
    <>
      <nav
        className={`fixed top-0 left-0 w-full z-50 px-6 py-4 flex items-center justify-between transition-all duration-300 ${isScrolled ? "bg-gray-900 shadow-md" : "bg-transparent"
          }`}
      >
        <h1
