...
export default function Session() {
  ...
  const handleNewMotion = async () => {
    ...
    toast.promise(
      loadNewMotion,
      {
        loading: "Generating new motion...",
        success: "New motion loaded successfully!",
        error: "Failed to load new motion",
      },
      {
        style: {
          borderRadius: "10px",
          ...
          <div className="bg-opacity-5 rounded-xl shadow-2xl p-3 sm:p-6 md:p-10 lg:p-12 w-full max-w-screen-xl mx-auto">
            ...
            <div className="text-center mt-8">
              <button
                ...
                className="px-6 py-2 bg-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-75 cursor-pointer transition-all duration-200"
              >
                New Motion
              </button>
            </div>
          ...
          <main className="p-2 sm:p-4 md:p-6 grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 text-white">
            <section className="md:col-span-3 pb-4 border-b border-gray-700 mb-4">
              ...
              <p className="leading-relaxed text-gray-200 text-base sm:text-lg">
                ...
                their critical thinking, public speaking, and analytical skills.
              </p>
            </section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
                <div>
                  ...
                  <ul className="list-disc list-inside ml-4 text-gray-200 leading-relaxed text-sm sm:text-base">
                    ...
                    <li>
                      <span className="font-bold">Protected Time:</span> Cannot
                      ask POIs during the first and last minute of a 7-minute
                      speech (i.e., POIs can be asked between 1 minute and 6
                      minutes).
                    </li>
                    <li>
                      Strategic tool used by opening half teams to engage with
                      closing half teams.
                    </li>
                    <li>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside ml-4 text-gray-200 leading-relaxed text-sm sm:text-base">
                    ...
                    <li>
                      Least preference = veto (i.e., motion will not be
                      debated).
                    </li>
                    <li>
                    ...
                    <ul className="list-disc list-inside ml-8 mt-1">
                      <li>
                        <span className="font-semibold">
                          Both teams veto different motions:
                        </span>{" "}
                        Motion #1 ❌, Motion #2 ✅, Motion #3 ❌ (Motion #2 is
                        debated)
                      </li>
                      <li>
                        <span className="font-semibold">
                          Both teams veto the same motion:
                        </span>{" "}
                        Motion #1 ❌❌, Motion #2, Motion #3
                        <ul className="list-disc list-inside ml-8 mt-1">
                          <li>
                            If both teams have the same first preference, that
                            motion is debated.
                          </li>
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12">
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-sm sm:text-base">
                <li>
                  ...
                  the world had that event or trend not happened.
                </li>
                <li>
                  Opposition teams then have to explain why the event/trend was
                  beneficial and why the alternative would have been worse.
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-sm sm:text-base">
                ...
                <li>
                  Arguments are for the truth or falsity of a particular
                  statement.
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-sm sm:text-base">
                ...
                <li>
                  <strong>This House Opposes:</strong> This House Regrets motion
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-sm sm:text-base">
                ...
                <li>
                  ...
                  policy/event/trend from one specific point of view.
                </li>
                <li>
                  Debaters are required to consider the best interests of the
                  actor.
                </li>
              </ul>
            </section>
            ...
            <section className="md:col-span-2">
              ...
              <ul className="list-disc list-inside space-y-2 text-sm sm:text-base">
                ...
                <li>
                  Opening Government has a lot of latitude in deciding aspects
                  of the policy:
                </li>
        ...
        <main className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 px-2 sm:px-4 md:px-0">
          <section className="md:col-span-2 bg-gray-800 p-3 sm:p-4 md:p-6 rounded-lg shadow-md border border-gray-700">
            ...
            <p className="mb-4 text-sm sm:text-base md:text-lg leading-relaxed">
              ...
              concepts like "Mechanism" and "Fiat" that underpin effective
              argumentation.
            </p>
            ...
            <div className="mb-4 sm:mb-6">
              ...
              <ul className="list-disc list-inside ml-4 leading-relaxed text-sm sm:text-base">
                ...
                <li className="mb-2">
                  <strong>Principle/Pragmatic:</strong> Explain why the action
                  is moral, or why it has positive impacts on a specific
                  actor/society.
                </li>
                <li>
                  <strong>Metrics:</strong> Set clear metrics to measure the
                  harms and positive impacts of the action.
                </li>
              </ul>
            </div>
            ...
            <div className="mb-4 sm:mb-6">
              ...
              <ul className="list-disc list-inside ml-4 leading-relaxed text-sm sm:text-base">
                <li className="mb-2">
                  ...
                  each side to justify the action that is being carried out by
                  the side.
                </li>
                <li>
                  <strong>Mechanism:</strong> Teams define a plan that achieves
                  the outcome of the motion in order to defend the "how".
                </li>
              </ul>
            </div>
            ...
            <div className="">
              ...
              <ul className="list-disc list-inside ml-4 leading-relaxed text-sm sm:text-base">
                <li className="mb-2">
                  ...
                  actors respond to that change.
                </li>
                <li className="mb-2">
                  When proposition claims that they can regulate drug sales to
                  prevent overdoses, opposition cannot question it until there
                  is logical analysis to refute it.
                </li>
                <li>
                  To ensure fairness, opposition can exercise the same amount of
                  fiat i.e. they have the ability to crack down on blackmarkets
                  to the same extent as drug dispensaries are regulated.
                </li>
              </ul>
            </div>
          </section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs sm:text-sm leading-relaxed">
                <div>
                  ...
                  <ul className="list-disc list-inside ml-4">
                    <li className="mb-1">
                      Why do fans have a legitimate stake in the ownership of
                      sports teams?
                    </li>
                    <li>
                      Why does the quality of grassroots sports improve when
                      fans own a sports team?
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="list-disc list-inside ml-4">
                    <li className="mb-1">
                      Why does private ownership mean more capital for sports
                      teams?
                    </li>
                    <li>
                      Why is more money good for (a) individual teams and by
                      extension their fans (b) for sport itself?
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="bg-gray-800 p-3 sm:p-4 md:p-6 rounded-lg shadow-md border border-gray-700">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs sm:text-sm leading-relaxed">
                <div>
                  ...
                  <ul className="list-disc list-inside ml-4">
                    <li className="mb-1">
                      Removal of all drug related offences from criminal
                      prosecution.
                    </li>
                    <li>
                      Regulated drug dispensaries with strict limits for
                      individuals as determined by a doctor.
                    </li>
                  </ul>
                  <p className="mt-2 text-xs italic">
                    <strong className="text-gray-500">Context:</strong> In
                    cities with thriving drug black markets and overdose deaths,
                    this regulated access saves lives and offers cheaper prices
                    to undercut the black market.
                  </p>
                </div>
                <div>
                  ...
                  <ul className="list-disc list-inside ml-4">
                    <li className="mb-1">
                      Stricter drug control through better policing & fairer CJS
                      reforms over time.
                    </li>
                    <li>
                      Identify at-risk individuals in schools, through the
                      social security system to provide therapy prior to
                      addiction and rehab if addicted.
                    </li>
                  </ul>
                  <p className="mt-2 text-xs italic">
                    <strong className="text-gray-500">Context:</strong>{" "}
                    Legalising drugs, increases access and chance of addiction;
                    craving for harder drugs - more OD deaths.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800 p-3 sm:p-4 md:p-6 rounded-lg shadow-md border border-gray-700">
              ...
              <div className="mb-4">
                ...
                <ul className="list-disc list-inside ml-4 text-xs sm:text-sm leading-relaxed">
                  ...
                  <li className="mb-1">
                    THBT the West should look to establish diplomatic
                    relationships with the Taliban government
                  </li>
                  <li>
                    THBT Queer movements in progressive nations should focus
                    their campaigning on family friendly content as opposed to
                    sexual liberation
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="list-disc list-inside ml-4 text-xs sm:text-sm leading-relaxed">
                  ...
                  <li className="mb-1">
                    THW make a minimum educational qualification mandatory for
                    politicians being nominated for positions in the cabinet
                  </li>
                  <li>
                    THW eliminate all patents resulting from scientific research
                    that was entirely publicly funded
                  </li>
                </ul>
              </div>
            </div>
        ...
        <main className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 px-2 sm:px-4 md:px-0">
          <section className="md:col-span-2 bg-gray-800 p-3 sm:p-4 md:p-6 rounded-lg shadow-md border border-gray-700">
            ...
            <p className="mb-4 text-sm sm:text-base md:text-lg leading-relaxed">
              ...
              into their unique argumentative requirements.
            </p>
            ...
            <div className="mb-6">
              ...
              <ul className="list-disc list-inside ml-4">
                <li className="mb-1">
                  <strong className="text-red-400">This House, as X</strong>
                </li>
                <li className="mb-1">
                  <strong className="text-red-400">
            ...
            <div className="mb-6">
              ...
              <ul className="list-disc list-inside ml-4 leading-relaxed">
                <li className="mb-2">
                  <strong>"As X"</strong>: X often refers to the specific actor
                  who is either carrying out the policy or who's interests must
                  be fulfilled.
                </li>
                <li>
                  <strong>Incentives</strong>: Every action is motivated by a
                  need to reach a specific end goal that is beneficial for the
                  actor. Teams must explain what the end goal is, why this is
                  the most important end goal for the actor, and how exactly it
                  gets achieved.
                </li>
              </ul>
            </div>
            ...
            <div className="mb-6">
              <h3 className="text-2xl font-semibold mb-3 border-b border-gray-600 pb-2">
                3. Example Motion: TH, as women from privileged backgrounds,
                will turn down benefits arising from affirmative action
                programmes
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm leading-relaxed">
                <div>
                  ...
                  <ul className="list-disc list-inside ml-4">
                    <li className="mb-1">
                      As someone who was brought up in a rich and connected
                      family by lottery of birth, it feels morally wrong to take
                      away the opportunities from people that actually need it.
                    </li>
                    <li className="mb-1">
                      Even if she reaches top leadership positions, it will be
                      viewed as a function of the quota rather than her talent.
                    </li>
                    <li>
                      The guilt and lack of respect will make it harder for her
                      to work effectively.
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="list-disc list-inside ml-4">
                    <li className="mb-1">
                      Privilege does not guarantee success, especially in
                      professions dominated by old boy's clubs and historically
                      led by men.
                    </li>
                    <li className="mb-1">
                      Therefore, affirmative action policies greatly increase
                      the chances of them reaching top leadership positions.
                    </li>
                    <li>
                      They can then leverage their power and authority to expand
                      the access to opportunities to all women.
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="mb-6">
              ...
              <ul className="list-disc list-inside ml-4 leading-relaxed">
                <li className="mb-2">
                  <strong>Retrospective</strong>: Evaluate past actions based on
                  their impacts in the present, and analyze why this was
                  beneficial or detrimental for certain actors.
                </li>
                <li>
                  <strong>Counterfactual</strong>: Teams that regret the motion
                  must provide reasoning about:
                  <ul className="list-circle list-inside ml-4 mt-1">
                    <li className="mb-1">
                      What the alternative could have been in the absence of
                      this virtue or notion.
                    </li>
                    <li className="mb-1">
          ...
          <aside className="md:col-span-1 space-y-8">
            <div className="bg-gray-800 p-6 rounded-lg shadow-md border border-gray-700">
              <h3 className="text-2xl font-semibold mb-3 text-green-400">
                5. Example Motion: THR the rise of social media as being the
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm leading-relaxed">
                <div>
                  ...
                  <ul className="list-disc list-inside ml-4">
                    <li className="mb-1">
                      ...
                      <ul className="list-circle list-inside ml-4 mt-1">
                        <li className="mb-1">
                          Traditional media sources, with a greater digital
                          presence.
                        </li>
                        <li>
                          Innovative new age media - Vox, Axios, The Athletic.
                        </li>
                      </ul>
                    </li>
                    <li>
                      <strong>
                        How has this rise changed news consumption?
                      </strong>
                      <ul className="list-circle list-inside ml-4 mt-1">
                        <li className="mb-1">
                          Most people reading trending tweets, Instagram posts
                          to be informed about facts.
                        </li>
                        <li>
                          News becoming less analytical and more anecdotal.
                        </li>
                      </ul>
                    </li>
                  </ul>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside ml-4">
                    <li className="mb-1">
                      <strong>
                        How would the world have been in the absence of social
                        media?
                      </strong>
                      <ul className="list-circle list-inside ml-4 mt-1">
                        <li className="mb-1">
                          Lesser access - scale (1 billion Facebook users vs 5
                          million NYTimes readers) and the nature of news
                          published.
                        </li>
                        <li>
                          Local news/information will not be as accessible -
                          this has max utility.
                        </li>
                      </ul>
                    </li>
                    <li>
                      Mitigate the negative effects of social media in current
                      society but cannot argue different policies that can fix
                      it.
                    </li>
                  </ul>
                </div>
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-md border border-gray-700">
              <h3 className="text-2xl font-semibold mb-3 text-purple-400">
                6. THS/O = This House Supports/Opposes
              </h3>
              <ul className="list-disc list-inside ml-4 leading-relaxed">
                <li className="mb-2">
                  <strong>Burden</strong>: Argue why a certain action is right
                  or wrong based on evidence.
                </li>
                <li>
                  <strong>How is this different from THBT/THW?</strong>
                  <ul className="list-circle list-inside ml-4 mt-1">
                    <li className="mb-1">
                      THBT = policy i.e. teams can design new solutions to
                      mitigate problems vs THO = teams must show the efficiency
                      of existing policies.
                    </li>
                    <li>
                      Teams MUST set up a counterfactual in these motions.
                    </li>
                  </ul>
                </li>
              </ul>
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-md border border-gray-700">
              <h3 className="text-2xl font-semibold mb-3 text-orange-400">
                7. Example Motion: THS non-violent property damage in order to
                stop climate change
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm leading-relaxed">
                <div>
                  ...
                  <ul className="list-disc list-inside ml-4">
                    <li className="mb-1">
                      ...
                      <ul className="list-circle list-inside ml-4 mt-1">
                        <li className="mb-1">
                          Blowing up pipelines, sabotaging logging equipment.
                        </li>
                        <li>
                          Meant to suspend operations temporarily and abruptly,
                          causing losses.
                        </li>
                      </ul>
                    </li>
                    <li>
                      <strong>When can we support this?</strong>
                      <ul className="list-circle list-inside ml-4 mt-1">
                        <li className="mb-1">
                          Brings popular attention to forgotten climate issues.
                        </li>
                        <li>
                          In the long term, increase costs for polluting
                          companies, which leads to suspending production or
                          becoming cleaner.
                        </li>
                      </ul>
                    </li>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside ml-4">
                    <li className="mb-1">
                      <strong>Counterfactual</strong>: civil protests, lawsuits,
                      support activist investors and back politicians that push
                      for greener policies/stricter controls.
                    </li>
                    <li className="mb-1">
                      <strong>Tradeoff?</strong> Takes time in order to effect
                      change, but saves the reputation environmental
                      organisations and keeps an open channel of negotiation
                      rather than confrontation.
                    </li>
                    <li>
                      <strong>Why oppose this?</strong> Unlikely to change
                      behavior, at the cost of more environmental damage, and
                      being portrayed as violent on popular media.
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-md border border-gray-700">
              <h3 className="text-2xl font-semibold mb-3 text-red-400">
                8. Motions to think about!
              </h3>
              <ul className="list-disc list-inside ml-4 leading-relaxed">
                <li className="mb-2">
                  <strong>
                    TH, as the IOC, would allow athletes to use
                    performance-enhancing drugs in the Olympics
                  </strong>
                  <p className="text-xs italic text-gray-500 ml-4">
                    (Think about how this is different from THW legalise
                    performance-enhancing drugs)
                  </p>
                </li>
                <li className="mb-2">
                  <strong>
                    TH, as the Biden Administration, would not have withdrawn
                    from Afghanistan
                  </strong>
                  <p className="text-xs italic text-gray-500 ml-4">
                    (This House Opposes Joe Biden's decision to withdraw
                    American troops from Afghanistan)
                  </p>
                </li>
                <li className="mb-2">
                  THR the characterisation of greed as immoral
                </li>
                <li className="mb-2">
                  THR the rising trend in pop culture to portray villains as a
                  victim of society
                </li>
                <li className="mb-2">
                  THR the increasing disinvestment in Public Sector Undertakings
                  in India
                </li>
                <li className="mb-2">
                  THS the existence of a technology that lets people see the
                  alternative outcomes of major life decisions they have made
                </li>
                <li className="mb-2">
                  THO states offering to make reparations through the acceptance
                  of refugees
                </li>
